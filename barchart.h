// barchart.h
// header file which creates one frame (barchart) - containing multiple bars (array), cap and size, and frame name
...
class BarChart {
 ...
 public:
    ...
    void graph(ostream &output, map<string, string> &colorMap, int top) {
        ...
        double max = bars[0].getValue();                 // for the top bar (max value)
